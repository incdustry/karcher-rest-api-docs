...
The current WP REST API integration version is `karcher` which takes a first-order position in endpoints. 
...
|-------------|----------------|--------------|---------------------------|
| `karcher`   | 3.5.x or later | 4.4 or later | -                         |
| `v3`        | 3.5.x or later | 4.4 or later | [v3 docs](https://woocommerce.github.io/woocommerce-rest-api-docs/) |
...
<div class="api-endpoint">
	<div class="endpoint-data">
		...
		<h6>/wp-json/wc/karcher?_jsonp=callback</h6>
	</div>
</div>

```shell
curl https://example.com/wp-json/wc/karcher/products/tags/34?_jsonp=tagDetails \
...
```
/**/tagDetails({"id":34,"name":"Leather Shoes","slug":"leather-shoes","description":"","count":0,"_links":{"self":[{"href":"https://example.com/wp-json/wc/karcher/products/tags/34"}],"collection":[{"href":"https://example.com/wp-json/wc/karcher/products/tags"}]}})%
```
...
Almost all endpoints accept optional parameters which can be passed as a HTTP query string parameter, e.g. `GET /clients?seen=completed`. All parameters are documented along each endpoint.
...
```
Link: <https://www.example.com/wp-json/wc/karcher/products?page=2>; rel="next",
<https://www.example.com/wp-json/wc/karcher/products?page=3>; rel="last"`
```
...
const WooCommerce = new WooCommerceRestApi({
  ...
  version: 'wc/karcher' // WooCommerce WP REST API version
});
```
