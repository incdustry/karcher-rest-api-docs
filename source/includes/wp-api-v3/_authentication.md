...
```shell
curl https://www.example.com/wp-json/wc/karcher/clients \
...
```shell
curl https://www.example.com/wp-json/wc/karcher/clients?consumer_key=123&consumer_secret=abc
```
...
The **Request URL** will be the endpoint you are posting to, e.g. `http://www.example.com/wp-json/wc/karcher/clients`.
...
```
GET&http%3A%2F%2Fwww.example.com%2Fwp-json%2Fwc%2Fkarcher%2Fclients&oauth_consumer_key%3Dabc123%26oauth_signature_method%3DHMAC-SHA1
```
